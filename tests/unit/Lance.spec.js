...
describe('Classe de Testes Lance', () => {
...
describe('um lance com valor minimo', () => {
    ...
    test('todos os lances devem possuir um valor minimo do informado', () => {
        const wrapper = mount(Lance, {
            propsData: {
                lanceMinimo: 300
            }
    ...
    test('nao são aceitos lances com valores menores do que o minimo informado', async () => {
        const wrapper = mount(Lance, {
            propsData: {
                lanceMinimo: 300
            }
